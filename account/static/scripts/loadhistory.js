$(function() {
    ...
    var loadhistorysock = new ReconnectingWebSocket(ws_scheme + '://' + window.location.host + "/loadhistory" + window.location.pathname);
    ...
    $("#read_old_messages").on("click", function(event) {
        var message = {
